...
export const cancelBooking = asyncHandler(async (req,res)=>{
    ...
    try{
        ...
        // each visit is passed to the function and it checks its id. if id matches then it returns that particular id
...
//function to add/remove a resd in favourite list of a user
